...
button.addEventListener('click', ()=>{
    ...
    if(time==i1){
        ...
        dynamicImage.style.backgroundImage="url('./images/wakeup_image.svg')";
    }

    else if(time==i2){
        textIndiv.innerHTML="LET'S HAVE SOME LUNCH !!";
        dynamicImage.style.backgroundImage="url('./images/lunch_image.png')";
    }

    else if(time==i3){
        textIndiv.innerHTML="LET'S HAVE A DINNER !!";
        dynamicImage.style.backgroundImage="url('./images/goodnight_image.svg')";
    }
